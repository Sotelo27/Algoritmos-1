...
'''
def definir_dias_biciesto(mes:int , anio:int):
    Esbiciesto = 2 #se pueden usar booleanos
...
#while mes <= 0 or mes >12 : #condicion en caso de ingresar un mes fuera de rango 
    #print('valor ingresado incorrecto,reingrese correctamente')
    #mes = int(input('Ingrese el mes: '))
definir_dias_biciesto(mes,anio)
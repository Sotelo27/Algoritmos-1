...
def precendencia_de_caracteres(cadena, caracter_1, caracter_2):
    ...
    encuentra inmediatamente antes (es decir, en el índice anterior) al caracter_2 
    en la cadena que se recibe como primer parámetro.
    '''
    contador = 0
    for caracteres in range(len(cadena)-1):
...
precendencia_de_caracteres("la igualdad de genero es fundamental para el desarrollo de una socieda", "a", "l")
